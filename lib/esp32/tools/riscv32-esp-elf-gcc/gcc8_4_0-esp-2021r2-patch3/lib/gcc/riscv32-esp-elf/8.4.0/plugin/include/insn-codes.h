...
enum insn_code {
  ...
  CODE_FOR_sibcall_internal = 236,
  CODE_FOR_sibcall_value_internal = 237,
  CODE_FOR_call_internal = 238,
  CODE_FOR_call_value_internal = 239,
  CODE_FOR_nop = 240,
  CODE_FOR_trap = 241,
  CODE_FOR_gpr_save = 242,
  CODE_FOR_gpr_restore = 243,
  CODE_FOR_gpr_restore_return = 244,
  CODE_FOR_riscv_frflags = 245,
  CODE_FOR_riscv_fsflags = 246,
  CODE_FOR_stack_tiesi = 247,
  CODE_FOR_stack_tiedi = 248,
  CODE_FOR_mem_thread_fence_1 = 249,
  CODE_FOR_atomic_storesi = 250,
  CODE_FOR_atomic_storedi = 251,
  CODE_FOR_atomic_addsi = 252,
  CODE_FOR_atomic_orsi = 253,
  CODE_FOR_atomic_xorsi = 254,
  CODE_FOR_atomic_andsi = 255,
  CODE_FOR_atomic_adddi = 256,
  CODE_FOR_atomic_ordi = 257,
  CODE_FOR_atomic_xordi = 258,
  CODE_FOR_atomic_anddi = 259,
  CODE_FOR_atomic_fetch_addsi = 260,
  CODE_FOR_atomic_fetch_orsi = 261,
  CODE_FOR_atomic_fetch_xorsi = 262,
  CODE_FOR_atomic_fetch_andsi = 263,
  CODE_FOR_atomic_fetch_adddi = 264,
  CODE_FOR_atomic_fetch_ordi = 265,
  CODE_FOR_atomic_fetch_xordi = 266,
  CODE_FOR_atomic_fetch_anddi = 267,
  CODE_FOR_atomic_exchangesi = 268,
  CODE_FOR_atomic_exchangedi = 269,
  CODE_FOR_atomic_cas_value_strongsi = 270,
  CODE_FOR_atomic_cas_value_strongdi = 271,
  CODE_FOR_mulditi3 = 304,
  CODE_FOR_umulditi3 = 305,
  CODE_FOR_usmulditi3 = 306,
  CODE_FOR_mulsidi3 = 307,
  CODE_FOR_umulsidi3 = 308,
  CODE_FOR_usmulsidi3 = 309,
  CODE_FOR_movdi = 310,
  CODE_FOR_movsi = 311,
  CODE_FOR_movhi = 312,
  CODE_FOR_movqi = 313,
  CODE_FOR_movsf = 314,
  CODE_FOR_movdf = 315,
  CODE_FOR_movmemsi = 316,
  CODE_FOR_clear_cache = 317,
  CODE_FOR_condjump = 318,
  CODE_FOR_cbranchqi4 = 319,
  CODE_FOR_cbranchsi4 = 320,
  CODE_FOR_cbranchdi4 = 321,
  CODE_FOR_cbranchsf4 = 322,
  CODE_FOR_cbranchdf4 = 323,
  CODE_FOR_cstoresi4 = 324,
  CODE_FOR_cstoredi4 = 325,
  CODE_FOR_cstoresf4 = 326,
  CODE_FOR_cstoredf4 = 327,
  CODE_FOR_indirect_jump = 328,
  CODE_FOR_tablejump = 329,
  CODE_FOR_prologue = 330,
  CODE_FOR_epilogue = 331,
  CODE_FOR_sibcall_epilogue = 332,
  CODE_FOR_return = 333,
  CODE_FOR_eh_return = 334,
  CODE_FOR_sibcall = 335,
  CODE_FOR_sibcall_value = 336,
  CODE_FOR_call = 337,
  CODE_FOR_call_value = 338,
  CODE_FOR_untyped_call = 339,
  CODE_FOR_mem_thread_fence = 340,
  CODE_FOR_atomic_compare_and_swapsi = 341,
  CODE_FOR_atomic_compare_and_swapdi = 342,
  CODE_FOR_atomic_test_and_set = 343
};

const unsigned int NUM_INSN_CODES = 344;
